...
**Reason**: A visão em cards de "Meus Ativos" foi removida; a tela passa a ser exibida somente em lista, alinhada ao padrão da aba "Lançamentos". O toggle cards/lista no cabeçalho deixa de existir.

**Migration**: Nenhuma ação do usuário é necessária — os mesmos ativos e campos continuam visíveis na visão em lista, agora a única visão da tela.

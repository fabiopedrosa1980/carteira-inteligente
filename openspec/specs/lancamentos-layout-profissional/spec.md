# lancamentos-layout-profissional

## Purpose

Define a apresentação profissional da tela de Lançamentos (`MyAssetsComponent`): faixa de resumo no cabeçalho com o total em destaque, alinhamento numérico das colunas da tabela, ritmo de espaçamento consistente, cabeçalho de seção legível como linha-resumo e estado vazio por seção. Estes requisitos são de apresentação — não alteram dados, rotas ou comportamento.

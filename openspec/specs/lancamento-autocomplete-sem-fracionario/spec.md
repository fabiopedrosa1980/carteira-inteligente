# lancamento-autocomplete-sem-fracionario Specification

## Purpose
TBD - created by archiving change meus-ativos-header-padrao-lancamentos. Update Purpose after archive.
## Requirements
